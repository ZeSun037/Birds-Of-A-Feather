...
public class Story16ScenarioTest {
    ...
    public void createDatabase() {
        ...
        newB1.setIsFavorite(1);
        newB2.setIsFavorite(1);
    ...
    public void testFavorites() {
        ...
        List<BoF> favs = db.boFDao().getFavorites();
        assertEquals(2, favs.size());
        assertEquals("TJ", favs.get(0).getName());
        assertEquals("AH", favs.get(1).getName());
    }
    ...
    public void testUnfavorite() {
        ...
        assertEquals(1, db.boFDao().getFavorites().size());
    }
